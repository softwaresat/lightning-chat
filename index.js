...
var db2 = new sqlite3.Database('/home/ravi/lightning-chat/chat.db');
app.use(session({
...
app.get('/', function(req, res) {
  ...
  let obj = {}
  let html = []
          db2.all("SELECT * FROM chatroom where author = ?", [req.session.name], async (err, author1) => {
...
http.listen(7290, () => console.log('Server is live on port 7290!'))
